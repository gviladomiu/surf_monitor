...
esta costa*. La nota suma puntos de cuatro factores (rango total **-1,0 a 5,0**;
el viento puede restar):

| Factor | Puntos | Detalle |
|--------|--------|---------|
| **Tamaño** | 0,5 – 2,0 | ≥1,2 m: +2 · ≥1,0 m: +1,5 · ≥0,8 m: +1 · resto: +0,5 |
| **Periodo del swell** | 0 – 1,5 | ≥6 s: +1,5 · ≥5 s: +1 · ≥4 s: +0,5 |
| **Viento** | **-1,5 a +1,0** | ver tabla abajo |
| **Consenso de modelos** | 0 – 0,5 | 4 modelos coinciden +0,5 · 3 +0,4 · 2 +0,25 · 1 +0 |

**Tabla de viento** (clase relativa a la playa × fuerza). A diferencia del
resto de factores, el viento puede **restar**: un viento del mar fuerte hunde
activamente la nota.

| Viento | ≤12 km/h | >12 km/h | >20 km/h |
|--------|---------|----------|----------|
| **Offshore** (de tierra) | +1,0 | 0,0 | 0,0 |
| **Cross-off** (lateral-tierra) | +0,7 | -0,3 | -0,3 |
| **Cross-on** (lateral-mar) | +0,3 | -0,6 | **-1,5** |
| **Onshore** (de mar) | 0,0 | -1,0 | **-1,5** |

El total se mapea: **≥4,8 → 5★** (y tamaño ≥1,0 m), ≥3,3 → 4★, ≥2,2 → 3★,
≥1,2 → 2★, resto → 1★.

Decisiones de diseño:
- **El viento manda y puede restar:** solo el viento flojo (≤12 km/h) suma; a
  partir de ahí penaliza, y el viento del mar fuerte (>20 km/h) hunde la nota
  -1,5. Un buen viento puede salvar un día mediocre de tamaño; un mal viento
  puede arruinar un día con buenas olas. Como en la realidad.
- **5 estrellas es muy raro y especial**: además de ≥4,8 puntos, exige tamaño
  real (≥1,0 m). En la práctica solo lo logra un día con tamaño ≥1,2 m, periodo
  ≥6 s, offshore flojo y consenso de modelos: lo mejor que da esta costa.
- **El tamaño pequeño no es excluyente**: un 0,8 m con offshore impecable puede
  llegar a 4★ (pero nunca a 5★, por el mínimo de tamaño).
...
Marine).| **Consenso de modelos** | 0 – 0,5 | 4 modelos coinciden +0,5 · 3 +0,4 · 2 +0,25 · 1 +0 |
